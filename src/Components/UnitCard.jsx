	...
	return (
		<div className="relative h-[430px] w-[320px] mb-[40px]">
			...
			<div className="flex flex-col h-[100px] mt-[10px]">
				<p className=" text-[15px] font-semibold text-[#626262] h-[18px]">
					Midtown East
				</p>
				<p className=" text-[20px] mt-[4px] font-semibold h-[25px]">
					Paragon #203
				</p>
				<p className=" text-[20px] mt-[4px] font-semibold h-[25px]">
					$4456 /month
				...
				<ul className="flex flex-row text-[15px] mt-[6px] text-[#626262] font-semibold h-[16px]">
					<li className="list-none">1 bed</li>
					<li className="list-none">
						<span className="inline-block rounded-full mr-[5px] ms-[5px]">
							&#8226;
						</span>{" "}
						1 Bath
					</li>
