...
export default function LoginWithGoogleAndApple() {
  return (
    <div className="flex flex-col gap-3">
      <div className="flex justify-center items-center gap-5 rounded-full border border-[#222222] py-[10px] px-10 cursor-pointer">
        <span>
          <svg
      ...
      <div className="flex justify-between items-center gap-5 rounded-full border bg-[#4285F4] text-white p-[6px] cursor-pointer">
        <span className="w-[36px] h-[36px] rounded-full bg-white flex justify-center items-center">
          <svg
            ...
            fill="none"
          >
            <g clipPath="url(#clip0_1443_7767)">
              <path
